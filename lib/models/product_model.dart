...
List<Product> products = [
  ...
  Product(
      ...
      price: 15),
  Product(
      image: 'drinks/caramelly_intense.png',
      name: 'Caramelly® Intense',
  ...
  Product(
      ...
      price: 18),
  Product(
      image: 'drinks/matcha_green_tea.png',
      name: 'Matcha Green® Tea',
      category: categories[1],
      price: 18),
  Product(
      image: 'drinks/milkshake.png',
      category: categories[1],
      name: 'Milk Shake® Beverage',
      price: 18),
  Product(
      image: 'drinks/mocha_coconut.png',
      category: categories[1],
      name: 'Mocha Coconut® Blended Beverage',
      price: 18),
  Product(
      ...
      price: 18),
  Product(
      image: 'drinks/vanila.png',
      category: categories[1],
      name: 'Vanilla® Blended Beverage',
      price: 18),
  Product(
